...
'">'+
tabName+
'</a></li>';}else if(currentPagepath.indexOf('apac')>-1||currentPagepath.indexOf('prnasia')>-1){if(tabNameFormatted=='news'){var tab='<li class="tab"><a class="tier-one panel-link '+
tabNameFormatted+
'" href="#mm-panel-'+
tabNameFormatted+
'">'+
tabName+
'</a></li>';}else{var tab='<li class="tab"><a class="tier-one panel-link" href="'+
tabLink+
'">'+
tabName+
